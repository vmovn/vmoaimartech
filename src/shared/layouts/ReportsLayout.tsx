...
/**
 * ReportsLayout — data-wall layout. Wide container, sticky filter bar,
 * children render at full width for tables and charts.
 */
export function ReportsLayout({
  ...
  return (
    <div className={cn("flex flex-col min-h-content", className)}>
      ...
      <Container size="wide" className="py-6 space-y-6 flex-1">
        {children}
      </Container>
    </div>
  );
