...
const SAMPLE_VARS: Record<string, string> = {
  ...
  support_email: "support@pm.ai.vn",
  sales_email: "sales@pm.ai.vn",
  workspace: "Acme Retail",
  workspace_name: "Acme Retail",
  organization: "Acme Retail",
  agent_name: "Jordan Lee",
  invite_link: "https://app.pm.ai.vn/accept-invite?token=demo",
  reset_link: "https://app.pm.ai.vn/auth/reset?token=demo",
  verify_link: "https://app.pm.ai.vn/auth/verify?token=demo",
  action_url: "https://app.pm.ai.vn",
  dashboard_url: "https://app.pm.ai.vn",
  amount: "USD 129.00",
