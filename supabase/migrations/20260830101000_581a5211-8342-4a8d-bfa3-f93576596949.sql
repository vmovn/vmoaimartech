-- Preserve membership audit history when a parent workspace is deleted.
-- Additive follow-up to the account-cleanup migration.
...
REVOKE ALL ON FUNCTION public.tg_workspace_members_audit() FROM PUBLIC, anon, authenticated;
